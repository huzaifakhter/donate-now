...
const MENU_ITEMS = [
  ...
  { href: "/admin/donations", label: "Donations", icon: BadgeDollarSign },
...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar Container */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-48 flex-col border-r border-outline-variant/30 bg-white transition-transform duration-300 lg:static lg:translate-x-0 ${
